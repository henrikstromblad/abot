...
//        {
//            return e.HasAttribute("rel") && !string.IsNullOrWhiteSpace(e.Attributes.GetNamedItem("rel").LocalName) &&
//                    string.Equals(e.Attributes.GetNamedItem("rel").LocalName, "canonical", StringComparison.OrdinalIgnoreCase) &&
//                    e.HasAttribute("href") && !string.IsNullOrWhiteSpace(e.Attributes.GetNamedItem("rel").LocalName) &&
//                    !string.Equals(e.Attributes.GetNamedItem("rel").LocalName, orginalUrl, StringComparison.OrdinalIgnoreCase);
//        }
